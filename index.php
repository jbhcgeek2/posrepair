			...
			<div class="container-xl">
				...
				<?php 
					...
					if($fechaHoy2 <= $fechaLimite && $rolUsuario == "Administrador"){
						?>
						<div class="card border mx-auto position-relative mb-3"
							style="max-width: 420px; border-width: 0.5px !important; border-radius: 12px;">

								<!-- Acento lateral -->
								<div class="position-absolute bg-primary"
									style="left: -1px; top: 14px; width: 3px; height: 36px; border-radius: 0 2px 2px 0;"></div>

								<div class="card-body p-4">
									<div class="d-flex gap-3 align-items-start">

										<!-- Ícono cuadrado -->
										<div class="bg-primary bg-opacity-10 flex-shrink-0 d-flex align-items-center justify-content-center"
										...
										<div class="flex-grow-1">
											<div class="d-flex justify-content-between align-items-start mb-1">
												<p class="mb-0 fw-semibold" style="font-size: 14px;">Reporte Mensual</p>
											</div>

											<p class="text-secondary mb-3" style="font-size: 13px; line-height: 1.5;">
												Tu reporte de <span class="text-primary fw-semibold">Mayo</span> ya está disponible.
											</p>

											<div class="d-flex gap-2">
												<a href="cierreMes.php?mes=05&year=2026" target="_blank" class="btn btn-sm"
