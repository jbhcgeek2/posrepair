		        ...
		        <div class="app-branding">
			    	...
			    	<nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
		                ...
		                <span class="nav-link-text">Ver Trabajos</span>
								...
								<li class="nav-item">
									<a href="reportesCaja.php" class="nav-link">
										<span class="nav-icon">
										...
										<ul class="submenu-list list-unstyled">
											...
											<?php 
												if($rolUsuario == "Administrador"){
													...
													<li class="submenu-item"><a class="submenu-link" href="validarInventario.php">Validar Inventario</a></li>
													<?php
												}
								...
								<?php 
									if($rolUsuario == "Administrador"){
										...
										<li class="nav-item">
										<!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
										<a class="nav-link" href="saldos.php">
											<span class="nav-icon">
											...
											<span class="nav-link-text">Mis Saldos</span>
										</a><!--//nav-link-->
									</li><!--//nav-item-->
										<?php
									}
