...
if(!empty($_SESSION['usuarioPOS'])){
  ...
  $data = [
      ...
      'messages' => [
          [
              'role' => 'system',
              'content' => 'Eres experto en analisis de datos y creacion de reportes financieros,
              estaras a cargo de crear los reportes de ventas mensuales (cierres de mes) para diferentes empresas 
              que se dedican a la reparacion de dispositivo mobiles, tablets, laptop y venta de accesorios para celulares.
              la respuesta tendra que ser en texto plano, sin incisos o puntos, tu respuesta debe ser formal y 
              en espanol.'
          ],
          [
              'role' => 'user',
  ...
  if ($error) {
      ...
      $respuestaIA = nl2br(htmlspecialchars($respuestaIA));
      $respuestaJSON = ['status'=>'ok','repuesta'=>$respuestaIA];
