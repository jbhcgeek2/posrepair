...
<body class="app">   	
  <?php
    ...
    if(!empty($_GET['infoProd'])){
      ...
      $sqlVal1 = "SELECT * FROM ARTICULOS WHERE empresaID = '$idEmpresaSesion' AND idArticulo = '$idProd'";
                                  ...
                                  <?php 
                                    ...
                                    try {
                                      ...
                                      while($fetchChip = mysqli_fetch_assoc($queryChip)){
                                        ...
                                        $idChip = $fetchChip['idChip'];
                                        $cadena = $fetchChip['productoID']."|".$fetchChip['sucursalID']."|".$idChip;
                                        echo "<tr>
                                          <td>$codChip</td>
                                          <td>$sucChip</td>
                                          <td>$fechaChip</td>
                                          <td>$usuarioChip</td>
                                          <td>
                                            <a href='#!' class='text-danger' id='$cadena' onclick='delChip(this.id)'>
